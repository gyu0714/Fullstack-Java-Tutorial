...
public class BloodTransfusionVirtualDB {
	...
	private BloodTransfusionProject BloodTransfusionProject;
...
//		System.out.println(projects);
	...
	public void insertProject(BloodTransfusionProject newProject) {
		projects.add(new BloodTransfusionProject("AB-","bt4",
				new Donor("donor4", "헌혈4", 52, "M", "AB-", "실험" ),
				new Recipient("recipient4", "수혈4", 83, "M", "AB-", "수술"),
				"응급 처치 프로제트"));
	}
